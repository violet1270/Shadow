...
<div class="container clearfix">
    ...
    <div class="main-wrap">
      <div class="crumb-wrap">
        <div class="crumb-list"><i class="icon-font"></i><a href="admin_index.php">后台管理</a><span class="crumb-step">&gt;</span><span class="crumb-name">新增库存</span></div>
      </div>
        ...
        <form id="myform" name="myform" method="post" action="insert.php">
          <table width="100%" height="173" border="0" align="center" cellpadding="2" cellspacing="1" class="result-tab">
            <tr>
              ...
              <td width="%85" class="td_bg"> <input name="bagid" type="text" id="bagid" size="20" maxlength="50" /></td>
            </tr>
            <tr>
              <td align="right" class="td_bg">设计师：</td>
              <td class="td_bg"><input name="designer" type="text" id="designer" size="40" maxlength="80" /></td>
            </tr>
            <tr>
              <td align="right" class="td_bg">手袋类型：</td>
              <td class="td_bg">
                <select name="type">
                  <option value="多功能包" selected>多功能包</option>
            ...
            <tr>
              <td align="right" class="td_bg">手袋颜色：</td>
              <td class="td_bg">
                <select name="color">
            ...
            <tr>
              ...
              <td class="td_bg"><input name="birth" type="text" id="birth" size="40" maxlength="80" /></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="td_bg"><input name="price" type="text" id="price" size="15" maxlength="80" />&emsp;元/天</td>
            </tr>
            <tr>
