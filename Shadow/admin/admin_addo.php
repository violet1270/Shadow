 ...
 <div class="container clearfix">
    ...
    <div class="main-wrap">
      <div class="crumb-wrap">
        <div class="crumb-list"><i class="icon-font"></i><a href="admin_index.php">后台管理</a><span class="crumb-step">&gt;</span><span class="crumb-name">订单状态更新</span></div>
      </div>
        ...
        <div class="result-content">
          <table class="result-tab" width="100%">
            ...
            <?php
              ...
              $pagesize=20;
              $sql = "select * from orders where ostatus='是' and oremarks='否' and ".@$_POST["search-type"]." like ('%".@$_POST["keywords"]."%')";
              //echo $sql;
              ...
              $sql="select * from orders where ostatus='是' and oremarks='否' and ".@$_POST["search-type"]." like ('%".@$_POST["keywords"]."%') order by bagid desc limit $startno,$pagesize";
              //echo $sql;
              $rs=mysqli_query($db_link,$sql);
              if(!$rs)
              {
              ...
              while($rows=mysqli_fetch_assoc($rs))
              {
                ...
                echo "<th class='tc'>";
                echo "<a href='update.php?olrid=".$rows["bagid"]."' class='link-update'>办理租赁</a>";
                echo "</th>";
                echo "</tr>";
              }
            ?>
