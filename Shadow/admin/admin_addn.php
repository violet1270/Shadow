...
<div class="container clearfix">
    ...
    <div class="main-wrap">
      <div class="crumb-wrap">
        <div class="crumb-list"><i class="icon-font"></i><a href="admin_index.php">后台管理</a><span class="crumb-step">&gt;</span><span class="crumb-name">租赁登记</span></div>
      </div>
      <div class="search-wrap">
        <div class="search-content">
          <form action="admin_addn.php" method="post">
            <table class="search-tab">
              <tr>
                <th width="120">查询条件</th>
                <td>
                  <select name="search-type" id="">
                  <option value="type">手袋类型</option>
	<option value="bagid" selected>手袋编码</option>
	<option value="color" >手袋颜色</option>
	<option value="designer">生产厂商</option>
                  </select>
                </td>
                <th width="70">关键字</th>
                <td><input class="common-text" placeholder="请输入查询条件" name="keywords" value="" id="" type="text"></td>
                <td><input class="btn btn-primary btn2" name="sub" value="查询可租赁手袋" type="submit"></td>
              </tr>
            </table>
          </form>
        </div>
          ...
          <table class="result-tab" width="100%">
            ...
            <?php
              ...
              while($rows=mysqli_fetch_assoc($rs))
              {
                ...
                echo "<th class='tc'>";
                echo "<a href='admin_order.php?orid=".$rows["bagid"]."'  class='link-update'>办理租赁</a>";
                echo "</th>";
                echo "</tr>";
              }
            ?>
