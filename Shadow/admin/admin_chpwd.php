 ...
 <div class="container clearfix">
    ...
    <div class="main-wrap">
      ...
      <?php
        ...
        if(@$_POST["Submit"])
        {
          if($rows["passwd"]==md5($_POST["password"]))
          {
          ...
          {
            echo "<script language='javascript'>alert('原始密码不正确,请重新输入');window.location='admin_pwd.php'</script>";
          }
        }
      ?>
          ...
          <div class="result-content">
            <table class="result-tab" width="100%">
              ...
              <tr> 
                ...
                <td class="td_bg"><input class="td_bg" onClick="return check();" type="submit" name="Submit" value="确定更改"></td>
              </tr>
            </table>
          </div>
        </form>
